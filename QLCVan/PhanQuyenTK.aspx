<%@ Page Title="Phân quyền nhóm" Language="C#" MasterPageFile="~/QLCV.Master" AutoEventWireup="true"
    CodeBehind="PhanQuyenTK.aspx.cs" Inherits="QLCVan.PhanQuyenTK" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="cv">
    ...
    <div class="table-wrap">
      <asp:GridView ID="gvPhanQuyenTK" runat="server" AutoGenerateColumns="False"
        CssClass="table table-bordered table-hover permissions-table"
        AllowPaging="False"
        OnRowCommand="gvPhanQuyenTK_RowCommand">
        <Columns>
          <asp:BoundField DataField="MaQuyen" HeaderText="Mã nhóm quyền" />
          <asp:BoundField DataField="TenQuyen" HeaderText="Tên nhóm quyền" />
